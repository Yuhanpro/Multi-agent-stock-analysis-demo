  ...
  theme: {
    extend: {
      colors: {
        ...
        reportHeading: "hsl(var(--theme-report-heading))",
        reportBody: "hsl(var(--theme-report-body))",
        reportMuted: "hsl(var(--theme-report-muted))",
        reportAccent: "hsl(var(--theme-report-accent))",
        fg:      "hsl(var(--theme-fg))",
