...
import { Activity, BarChart2, Clock, Coins, Flame, HelpCircle, Lightbulb, Menu, MessagesSquare, PieChart, Radar, Shield, Star, Stethoscope, X } from "lucide-react";
...
const NAV: NavItem[] = [
  ...
  { href: "/recommend", icon: Lightbulb, key: "nav.recommend" },
  { href: "/hotspot", icon: Radar, key: "nav.hotspot" },
  { href: "/gold", icon: Coins, key: "nav.gold" },
