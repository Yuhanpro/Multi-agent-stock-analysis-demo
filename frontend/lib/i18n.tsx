...
const DICT = {
  en: {
    ...
    "mode.snapshot.meta":  "Free · ~1s",
    "mode.quick.label":    "Buffett Quick",
    "mode.quick.hint":     "Single-agent value review",
    "mode.quick.meta":     "~30-60s · ~$0.003",
    "mode.serenity.label": "Serenity Scan",
    "mode.serenity.hint":  "Supply-chain bottleneck research",
    "mode.serenity.meta":  "~50-80s · ~$0.003",
    "mode.debate.label":   "Multi-Agent Debate",
    "mode.debate.hint":    "TradingAgents panel debate",
    "mode.debate.meta":    "~3-6min · ~$0.25",
    // input
    ...
    // empty state
    "empty.hint":     "Choose a mode, enter a ticker, and start with Snapshot for a free sanity check.",
    "empty.examples": "Try AAPL, NVDA, or 600519 (CN).",
    "empty.tip":      "Quick and Serenity stream token-by-token; Debate updates as each agent finishes." ,
    // snapshot card
  ...
  zh: {
    ...
    "mode.snapshot.meta":  "免费 · 约 1 秒",
    "mode.quick.label":    "巴菲特速评",
    "mode.quick.hint":     "单 agent 价值判断",
    "mode.quick.meta":     "约 30-60 秒 · ~$0.003",
    "mode.serenity.label": "Serenity 产业链扫描",
    "mode.serenity.hint":  "供应链瓶颈研究",
    "mode.serenity.meta":  "约 50-80 秒 · ~$0.003",
    "mode.debate.label":   "多 agent 辩论",
    "mode.debate.hint":    "TradingAgents 圆桌辩论",
    "mode.debate.meta":    "约 3-6 分钟 · ~$0.25",
    "input.market.us":          "美股",
    "input.market.cn":          "A 股",
    "input.placeholder.us":     "AAPL、NVDA、TSLA…",
    "input.placeholder.cn":     "600519、000001…",
    ...
    "empty.hint":     "先选择分析模式,再输入股票代码。建议先用行情快照做免费检查。",
    "empty.examples": "可以试试 AAPL、NVDA,或 600519(A 股)。",
    "empty.tip":      "巴菲特速评和 Serenity 会逐 token 输出;多 agent 辩论会在每个 agent 完成后更新。",
    "snap.marketcap":     "总市值",
    "snap.pe":            "市盈率 (TTM)",
    "snap.pb":            "市净率",
    "snap.dividend":      "股息率",
