...
export interface DailyPoint { date: string; views: number; visitors: number; new_visitors: number; analyses: number; runs: number; runs_signed: number; runs_anon: number; signups: number; cost: number; }
